...
int main(int argc, char** argv) {
    ...
    if (dynamic) {
        // The measurement is focused on the strongest short acoustic region
        // inside each 40 ms window. A 20 ms hop halves FFT work versus the
        // previous 10 ms grid while retaining adequate temporal resolution
        // for microphone-distance movement.
        ...
        settings.dynamicEventMinSeparationMs = 60.0;
